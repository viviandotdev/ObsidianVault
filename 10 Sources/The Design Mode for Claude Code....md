...
```
Help me rebuild the exact same sidebar mobile component UI design as the html provided,here is the extracted css, and an image of the UI is also provided
